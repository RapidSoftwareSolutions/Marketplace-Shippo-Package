<?php
$app->post('/api/Shippo/createTransactionBasedOnRate', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'rateId']);
    ...
    $body['rate'] = $post_data['args']['rateId'];
