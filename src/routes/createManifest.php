<?php
$app->post('/api/Shippo/createManifest', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . "manifests";

    $body['carrier_account'] = $post_data['args']['carrierAccountObjectId'];
